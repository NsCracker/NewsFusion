...
export class News extends Component {
  ...
  constructor(props) {
    ...
    document.title = `NewsFusion - ${this.capitalizeFirstLetter(this.props.category)}`;
  }

  async updateNews() {
    this.props.setProgress(10);
    const url = `https://newsapi.org/v2/top-headlines?country=${this.props.country}&category=${this.props.category}&apiKey=2d8811c38ec947aeafc80cddc5596cef&page=${this.state.page}&pagesize=${this.props.pageSize}`;
